        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-2xl p-6 border-2 border-gray-200 hover:border-[#1110C4] transition-colors">
                <h4 className="text-lg font-bold text-gray-900 mb-2">Single Touch Leads</h4>
                <p className="text-gray-600">
                  Contacts validated through one direct outreach attempt (email or LinkedIn), confirming accuracy 
                  and role relevance.
                </p>
              </div>
              <div className="bg-white rounded-2xl p-6 border-2 border-gray-200 hover:border-[#1AD603] transition-colors">
                <h4 className="text-lg font-bold text-gray-900 mb-2">Double Touch Leads</h4>
                <p className="text-gray-600">
            ...
            {/* BANT */}
            <div className="bg-gradient-to-br from-[#1110C4] to-[#0B0A8A] rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">BANT Qualified Leads</h3>
              ...
              <div className="grid sm:grid-cols-4 gap-4">
                {['Budget', 'Authority', 'Need', 'Timeline'].map((item, i) => (
          ...
          <div className="space-y-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-[#1AD603] flex-shrink-0 mt-1" />
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#1AD603] rounded-full opacity-20 blur-3xl"></div>
              </div>
            </div>

            {/* ABM */}
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-10 border-2 border-gray-100">
                ...
                {[
                  {
                    ...
                    desc: 'In-depth account research and decision-maker identification'
                  },
                  {
                    title: 'Personalized Campaigns',
                    desc: 'Tailored content and messaging across multiple channels'
                  },
                  {
                    title: 'Data-Driven Optimization',
                    desc: 'Track engagement and optimize for measurable results'
                  }
                ].map((item, i) => (
                ...
                <div className="aspect-square rounded-2xl overflow-hidden border-4 border-gray-100 shadow-xl">
                  <img 
                    ...
                    onError={(e) => {
                      e.target.style.display = 'none';
                      e.target.parentElement.classList.add('flex', 'items-center', 'justify-center', 'bg-gradient-to-br', 'from-[#1110C4]/10', 'to-[#1AD603]/10');
                      e.target.parentElement.innerHTML = '<div class="text-center p-8"><div class="text-6xl mb-4">📅</div><div class="text-gray-600">Appointments</div></div>';
                    }}
                  />
                </div>
                <div className="absolute -top-6 -left-6 w-32 h-32 bg-[#1110C4] rounded-full opacity-20 blur-3xl"></div>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="space-y-16">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="md:pl-12">
                  <div className="bg-gradient-to-br from-[#1110C4] to-[#0B0A8A] rounded-2xl p-6 text-white">
                    ...
                    <ul className="space-y-2">
                      {[
                        ...
                        <li key={i} className="flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-[#1AD603]" />
      ...
      <section className="relative bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            {/* Content Syndication */}
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-8 border-2 border-gray-200 hover:border-[#1110C4] transition-colors">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#1110C4] to-[#0B0A8A] hover:from-[#1AD603] hover:to-[#2BEC06] flex items-center justify-center transition-all duration-300">
                  <FileText className="h-6 w-6 text-white" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900">Content Syndication</h3>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-gray-200">
                  <CheckCircle2 className="h-5 w-5 text-[#1110C4] flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Enhanced Visibility</h4>
                    <p className="text-sm text-gray-600">Distribute content across multiple channels</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-gray-200">
                  <CheckCircle2 className="h-5 w-5 text-[#1110C4] flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Qualified Engagement</h4>
                    <p className="text-sm text-gray-600">Connect with prospects showing genuine interest</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-gray-200">
                  <CheckCircle2 className="h-5 w-5 text-[#1110C4] flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Actionable Opportunities</h4>
                    <p className="text-sm text-gray-600">Generate sales-ready leads from content engagement</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#1110C4] to-[#0B0A8A] rounded-3xl p-8 text-white">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 p-3 bg-white/10 backdrop-blur-sm rounded-xl">
                    <div className="w-2 h-2 bg-[#1AD603] rounded-full"></div>
                    <span className="text-white/90">{item}</span>
                  </div>
                ))}
